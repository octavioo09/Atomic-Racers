#include "OutVideoMenuScene.hpp"

#include "../man/GameManager.hpp"
#include "../util/JsonManager.hpp"

void OutVideoMenuScene::loadMenu(std::string path, EManager& EM, EntityFactory& EF){
...
void OutVideoMenuScene::init()
{
    loadMenu("assets/JSON/menus/out_video_menu.json", EM, Factory);    
}

void OutVideoMenuScene::update(float deltaTime)
{
...
void OutVideoMenuScene::update_sim(float simDeltaTime)
{
    // Actualizar la escena
}

void OutVideoMenuScene::render()
{
    Rsystem.update(EM, gameManager.getRenderManager());
}

void OutVideoMenuScene::cleanup()
{
