#include "OutControlesScene.hpp"

#include "../man/GameManager.hpp"
#include "../util/JsonManager.hpp"

void OutControlesScene::loadMenu(std::string path, EManager& EM, EntityFactory& EF){
...
void OutControlesScene::init()
{    
    loadMenu("assets/JSON/menus/out_controles.json", EM, Factory);    
}


void OutControlesScene::update(float deltaTime)
{
...
void OutControlesScene::update_sim(float simDeltaTime)
{
    // Actualizar la escena
}

void OutControlesScene::render()
{
    Rsystem.update(EM, gameManager.getRenderManager());
}

void OutControlesScene::cleanup()
{
