#include "OutGameOptionsScene.hpp"

#include "../man/GameManager.hpp"
#include "../util/JsonManager.hpp"

void OutGameOptionsScene::loadMenu(std::string path, EManager& EM, EntityFactory& EF){
...
void OutGameOptionsScene::init()
{    
    loadMenu("assets/JSON/menus/out_ajustes.json", EM, Factory);    
}


void OutGameOptionsScene::update(float deltaTime)
{
...
void OutGameOptionsScene::update_sim(float simDeltaTime)
{
    // Actualizar la escena
}

void OutGameOptionsScene::render()
{
    Rsystem.update(EM, gameManager.getRenderManager());
}

void OutGameOptionsScene::cleanup()
{
