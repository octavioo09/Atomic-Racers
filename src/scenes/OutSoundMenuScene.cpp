#include "OutSoundMenuScene.hpp"

#include "../man/GameManager.hpp"
#include "../util/JsonManager.hpp"

void OutSoundMenuScene::updateVolumeSprites(int startIdx, int endIdx, int volume) {
...
void OutSoundMenuScene::loadMenu(std::string path, EManager& EM, EntityFactory& EF){
...
void OutSoundMenuScene::init()
{
    loadMenu("assets/JSON/menus/out_audio_menu.json", EM, Factory);    
}

void OutSoundMenuScene::update(float deltaTime)
{
...
void OutSoundMenuScene::update_sim(float simDeltaTime)
{
    // Actualizar la escena
}

void OutSoundMenuScene::render()
{
    Rsystem.update(EM, gameManager.getRenderManager());
}

void OutSoundMenuScene::cleanup()
{
    EM.resetEntityManager();
    // vaciamos el array de sprites
