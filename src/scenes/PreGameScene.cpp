...
void PreGameScene::loadPreGame(std::string path, EManager& EM, EntityFactory& EF){
...
{
    loadPreGame("assets/JSON/menus/sel_car.json", EM, Factory);
...
void PreGameScene::update(float deltaTime)
{
    //WARNING ALE
...
void PreGameScene::update_sim(float simDeltaTime)
{
